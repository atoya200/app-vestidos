        ...
        <div className="mt-8 space-y-8">
          ...
          <section className="border-b border-slate-200 dark:border-slate-800 pb-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <div className="flex items-center justify-center w-10 h-10 rounded-full bg-fuchsia-100 dark:bg-fuchsia-900/30">
                ...
                <div>
                  ...
                  <a href="tel:+5491123456789" className="text-lg font-medium hover:text-fuchsia-600">
                    098 123 321
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@glamrent.com" className="text-lg font-medium hover:text-fuchsia-600">
                    info@glamrent.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-slate-500 dark:text-slate-400">Horario de atención</p>
                  <p className="text-lg font-medium">Lunes a Viernes: 9:00 - 18:00hs</p>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Sábados: 10:00 - 14:00hs</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="pb-6">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-6">
              Mantente al día con nuestras últimas colecciones, promociones y consejos de moda.
            </p>
            
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {/* Instagram */}
              <div className="flex flex-col items-center gap-3 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-fuchsia-600 dark:hover:border-fuchsia-600 transition-colors cursor-pointer">
